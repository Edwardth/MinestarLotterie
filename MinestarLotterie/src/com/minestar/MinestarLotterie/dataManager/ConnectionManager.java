...
public class ConnectionManager {
    ...
    public static boolean initialize() {
        ...
        if (instance != null) {
            Main.log.warning("Connection is already initialized! Check for double initiations!");
            return false;
        }
    ...
    public static void closeConnection() {
        ...
        if (instance != null) {
            try {
                ...
                Main.log.warning("Error while closing the database connection!");
            }
        }
    }
    ...
    private static boolean createConnection() {
        ...
        try {
            ...
            instance = DriverManager
                    .getConnection("jdbc:sqlite:plugins/MinestarLotterie/Lotterie.db");
            instance.setAutoCommit(false);
        }
        catch (Exception e) {
            Main.log.warning("Error while creating database connection!");
            return false;
        }
        return true;
    }
